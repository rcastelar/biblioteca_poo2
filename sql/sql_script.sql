...
-- -----------------------------------------------------
-- Table `biblioteca`.`usuario_has_livro`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `biblioteca`.`usuario_has_livro` (
...
CREATE INDEX `fk_usuario_has_livro_livro1_idx` ON `biblioteca`.`usuario_has_livro` (`livro_id` ASC);

CREATE INDEX `fk_usuario_has_livro_usuario1_idx` ON `biblioteca`.`usuario_has_livro` (`usuario_id` ASC);
